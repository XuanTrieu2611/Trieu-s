...
Item {
    ...
    Image {
        id: batteryBar
        source: "qrc:/image/batteryimage/battery_bar.png"
        visible: false
        width: 245
        height: 120
    }
    ...
    ParticleSystem {
        ...
        ImageParticle {
            source: "qrc:/image/batteryimage/particle.png"
    ...
    Item {
        ...
        Image {
            id: levelImage
            source: "qrc:/image/batteryimage/bar_level2.png"
    ...
    ParticleSystem {
        ...
        ImageParticle {
            groups: ["first", "second"]
            source: "qrc:/image/batteryimage/lightning.png"
    ...
    Image {
        id: batteryImage
        source: "qrc:/image/batteryimage/battery2.png"
        width: 240
        height: 120
    }
