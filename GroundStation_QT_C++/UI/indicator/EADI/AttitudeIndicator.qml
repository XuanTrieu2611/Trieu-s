...
Item {
    ...
    CustomImage {
        ...
        width: 210
        height: 420
        source: "qrc:/image/eadi/eadi_adi_back.svg"
    ...
    CustomImage {
        ...
        y: -175
        width: 80
        source: "qrc:/image/eadi/eadi_adi_ladd.svg"
    ...
    CustomImage {
        ...
        y: 20
        width: 210
        source: "qrc:/image/eadi/eadi_adi_roll.svg"
    ...
    CustomImage {
        ...
        y: 68
        width: 9
        source: "qrc:/image/eadi/eadi_adi_slip.svg"
    ...
    CustomImage {
        ...
        y: 188
        width: 10
        source: "qrc:/image/eadi/eadi_adi_doth.svg"
    ...
    CustomImage {
        ...
        y: 120
        width: 10
        source: "qrc:/image/eadi/eadi_adi_dotv.svg"
        sourceSize.height: 40
        sourceSize.width: 40
        visible: dotVVisible
        transform: Translate {
    ...
    CustomImage {
        ...
        y: 0
        width: 300
        source: "qrc:/image/eadi/eadi_adi_scaleh.svg"
    ...
    CustomImage {
        ...
        y: 0
        width: 300
        source: "qrc:/image/eadi/eadi_adi_scalev.svg"
        sourceSize.height: 1200
        sourceSize.width: 1200
        visible: dotVVisible
    }
    ...
    CustomImage {
        ...
        y: 124.5
        height: 18
        source: "qrc:/image/eadi/eadi_adi_fd.svg"
    ...
    CustomImage {
        ...
        y: 113
        height: 19
        source: "qrc:/image/eadi/eadi_adi_fpm.svg"
    ...
    CustomImage {
        ...
        y: 113
        height: 19
        source: "qrc:/image/eadi/eadi_adi_fpmx.svg"
        sourceSize.height: 76
        sourceSize.width: 120
        transform: Translate {
            x: pixelPerDegree * sideSlipAngle
    ...
    CustomImage {
        ...
        y: 0
        height: 300
        source: "qrc:/image/eadi/eadi_adi_mask.svg"
        sourceSize.height: 1200
        sourceSize.width: 1200
    }
    ...
    CustomImage {
        ...
        y: 206
        height: 4
        source: "qrc:/image/eadi/eadi_adi_turn.svg"
    ...
    CustomImage {
        ...
        y: 91
        width: 56
        source: "qrc:/image/eadi/eadi_adi_stall.svg"
