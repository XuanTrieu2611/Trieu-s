...
Item {
    ...
    CustomImage {
        ...
        y: 210
        height: 90
        source: "qrc:/image/eadi/eadi_hsi_back.svg"
    ...
    CustomImage {
        ...
        y: 233
        width: 224
        source: "qrc:/image/eadi/eadi_hsi_face.svg"
    ...
    CustomImage {
        ...
        y: 233
        width: 224
        source: "qrc:/image/eadi/eadi_hsi_bug.svg"
        sourceSize.height: 2240
        sourceSize.width: 2240
        transform: Rotation {
            origin.x: (150 - 38)
    ...
    CustomImage {
        ...
        y: 217
        height: 73
        source: "qrc:/image/eadi/eadi_hsi_marks.svg"
